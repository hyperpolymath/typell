...
// Replace typell, Typell — See README.adoc for details., just run, Typell started successfully. with actuals
= typell — Quick Start for Users
:toc:
:toclevels: 2

== What is typell?

Typell — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./typell-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/typell/wiki
