...
#
# TODO: Replace Typell and PanLL's verification kernel — dependent types, linear types, session types, QTT, proof-carrying code, and effect systems for neurosymbolic query languages with actual values.

{
  description = "Typell — RSR-compliant project";
    ...
    flake-utils.lib.eachSystem [ "x86_64-linux" "aarch64-linux" ] (system:
      ...
      in
      {
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            echo "TODO: Add build commands for Typell"
          '';
          ...
          meta = with pkgs.lib; {
            description = "PanLL's verification kernel — dependent types, linear types, session types, QTT, proof-carrying code, and effect systems for neurosymbolic query languages";
            homepage = "https://github.com/hyperpolymath/Typell";
