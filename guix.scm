...
;;
;; Guix package definition for Typell
;;
;; Usage:
;;   guix shell -D -f guix.scm    # Enter development shell
;;   guix build -f guix.scm       # Build package
;;
;; TODO: Replace Typell and customize inputs for your language/stack.
...
(package
  ...
  (home-page "https://github.com/hyperpolymath/Typell")
  (synopsis "PanLL's verification kernel for neurosymbolic query languages")
