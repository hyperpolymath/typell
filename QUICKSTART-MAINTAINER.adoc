...
// Replace typell, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= typell — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining typell for
...
* Upstream: https://github.com/hyperpolymath/typell/issues
